...
@SuppressWarnings({"WeakerAccess", "unused"}) public class LottieDrawable extends Drawable implements Drawable.Callback {
    ...
    public ThreadPoolExecutor threadPool = new ThreadPoolExecutor(1, 2, 5, TimeUnit.SECONDS,
            ...
            new ThreadFactory() {
                ...
                public Thread newThread(@NonNull Runnable r) {
                    return new Thread(r, "LottieThread #" + this.mCount.getAndIncrement());
                }
    ...
    public Map<String,Bitmap> getBitmapCatch(){
        return bitmapMap;
    }

    public void setBitmapCatch(String id,Bitmap bitmap){
        if (bitmap == null) {
            return;
        }
